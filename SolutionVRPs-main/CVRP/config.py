...
def arg_parser():
	...
	parser.add_argument('-bs', '--batch_steps', metavar = 'BS', type = int, default = 1000, help = 'number of samples = batch * batch_steps')
	...
	parser.add_argument('-wd', '--weight_dir', metavar = 'MD', type = str, default = os.path.join(BASE_DIR ,'Weights/'), help = 'model weight save dir')
...
def train_parser():
	...
	parser.add_argument('-p', '--path', metavar = 'P', type = str, 
						default = os.path.join(BASE_DIR,'Pkl/VRP20_train.pkl'),
