...
# 	g20_train = np.load('My-20-training.npz')
	g20_train = np.load(os.path.join( BASE_DIR,'tc/my-41-training.npz'))
	depot_xy = g20_train['graph'][0:n_samples, 0, :]
	customer_xy = g20_train['graph'][0:n_samples, 1:n_customer+1, :]
	demand = g20_train['demand'][0:n_samples:, 1:n_customer+1]
